...
from src.schemas.place import PlaceCreateRequest, PlaceUpdate, PlaceResponse
from src.services.place_service import create_place, update_place, delete_place
from src.core.unit_of_work import UnitOfWork
from src.api.dashboard.dependencies import dashboard_guard, admin_guard
...
def create_new_place(
    request_data: PlaceCreateRequest,
    uow: UnitOfWork = Depends(get_uow),
    current_user: User = Depends(admin_guard),
):
    return create_place(uow, request_data, current_user)
